        ...
        <div class="page-body">
          <div class="container-xl">
    		...
    		<tr>
    			...
    			<td colspan="3">
    			<c:if test="${imgvo.img_file1 != ' '}">
    			<img src="${cpath}/upload/${imgvo.img_file1}"><Br>
    			</c:if>
    			<c:if test="${imgvo.img_file2 != ' '}">
    			<img src="${cpath}/upload/${imgvo.img_file2}"><Br>
    			</c:if>
    			<c:if test="${imgvo.img_file3 != ' '}">
    			<img src="${cpath}/upload/${imgvo.img_file3}"><Br>
    			</c:if>
    			<c:if test="${imgvo.img_file4 != ' '}">
    			<img src="${cpath}/upload/${imgvo.img_file4}"><Br>
    			</c:if>
    			<c:if test="${imgvo.img_file5 != ' '}">
    			<img src="${cpath}/upload/${imgvo.img_file5}"><Br>
    			</c:if>
    			${fn:replace(imgvo.img_content,newLineChar,"<br/>")}</td>
    		...
    		<tr>
    			...
    			<c:if test="${imgvo.login_id  eq mvo.login_id}">
    				<button class="btn btn-outline-success w-5" onclick="goUpdate(${imgvo.img_seq})">수정</button>
    				<button class="btn btn-outline-danger w-5" onclick="goDel(${imgvo.img_seq})">삭제</button>
    			</c:if>
                    ...
                    <form id="writeComment">
                      <div class="row">
                        ...
                        <div class="col-7">
                          ...
                          <textarea class="form-control mt-3" id="content" type="text" name="img_cmt_content" rows="3"
