						...
						<div class="row row-cards">
							<table class="table mb-0" id="view">
								...
								<tr>
									...
									<td colspan="3"><c:if test="${vo.buy_file != ' ' }">
											<img src="${cpath}/upload/${vo.buy_file}">
											<Br>
											...
											<div class="card-header">
												...
												<ul class="  nav nav-pills card-header-pills "
													...
													<li class=" nav-item " role="presentation"><a
														...
														data-bs-toggle="tab" aria-selected="true" role="tab">댓글</a></li>
													<li class="  nav-item" role="presentation"><a
														href="#tab-form" class=" nav-link" data-bs-toggle="tab"
														aria-selected="false" tabindex="-1" role="tab" onclick="javascript:bbformlist()">신청하기</a></li>
