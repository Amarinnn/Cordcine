                ...
                <table class="table table-vcenter table-hover">
                  ...
                  <c:forEach  var="vo" items="${notice }"> 
    					<tr>
			    			...
			    			<td><a href="${cpath }/buyboardView.do?num=${vo.buy_seq}&p=${board.currentPage}&login_id=${mvo.login_id}" class="text-reset">${vo.buy_title }<span class="text-orange">&nbsp;[${vo.buy_cmtcnt }]</span></a></td>
			    			...
			    			<td class="text-muted text-center">${vo.buy_likes }</td>
			    		</tr>
    				</c:forEach>
              ...
              <div class="card-footer d-flex align-items-center py-2">
                ...
                <c:if test="${board.pagingPerCount<board.start_page}">
                  <li class="page-item abled">
                    <a class="page-link" href="${cpath }/buylist.do?p=${board.start_page-1}" tabindex="-1" aria-abled="true">
				    ...
				    <c:forEach var="i" begin="${board.start_page}" end="${board.end_page}">
					    ...
					    <li class="page-item "><a class="page-link" href="${cpath }/buylist.do?p=${i}">${i}</a></li>
					    </c:otherwise>
					    </c:choose>
				    </c:forEach>
				...
				<c:if test="${board.numPageCount>board.end_page}">
					<li class="page-item abled"><a class="page-link" href="${cpath }/buylist.do?p=${board.end_page+1}" tabindex="1" aria-abled="true">next
					<svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" 
                      stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" 
                      stroke-linejoin="round">
