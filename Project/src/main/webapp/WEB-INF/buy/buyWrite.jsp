      ...
      <div class="page-wrapper">
        ...
        <div class="page-body">
          <div class="container-xl">
            ...
            <form action="${cpath }/buyboardWrite.do" method="post" name="writeForm" enctype="multipart/form-data" accept-charset="UTF-8" onsubmit="return checkForm()">
    		<table class="table table-bordered">
    			...
    			<tr>
    				...
    				<button type="button" class ="btn btn-warning btn-sm" onclick="location.href='${cpath }/buylist.do'">취소</button>
    				</Td>
    			</tr>
    		</table>
    	</form>
