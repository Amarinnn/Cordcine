...
<script>
	...
	function goWrite(){
		if(${mvo.login_id==null}){
			...
			location.href='${cpath}/boardWriteForm.do';
		}
	}
              ...
              <div class="card-footer d-flex align-items-center py-2">
                ...
                <c:if test="${board.pagingPerCount<board.start_page}">
                  <li class="page-item abled">
                    <a class="page-link" href="${cpath }/zwlist.do?p=${board.start_page-1}" tabindex="-1" aria-abled="true">
				    ...
				    <c:forEach var="i" begin="${board.start_page}" end="${board.end_page}">
					    ...
					    <li class="page-item "><a class="page-link" href="${cpath }/zwlist.do?p=${i}">${i}</a></li>
					    </c:otherwise>
					    </c:choose>
				    </c:forEach>
				...
				<c:if test="${board.numPageCount>board.end_page}">
					<li class="page-item abled"><a class="page-link" href="${cpath }/zwlist.do?p=${board.end_page+1}" tabindex="1" aria-abled="true">next
					<svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" 
                      stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" 
                      stroke-linejoin="round">
                  ...
                  <div class="row m-auto mb-3">
                    ...
                    <div class="col-auto">
                      <select type="text" class="form-select" name ="val" placeholder="Select a date" id="select-tags" value="">
                        ...
                        <option value="zw_content">내용</option>
                      </select>
                    </div>
                    <div class="col-4">
