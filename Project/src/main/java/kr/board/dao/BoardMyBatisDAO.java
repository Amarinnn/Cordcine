...
//		public List<BCommFormGds> BCommFormListGds (int num){
//			SqlSession session =sqlSessionFactory.openSession();
//			List<BCommFormGds> list =sessiV4 selectList("BCommFormListGds",num);
//			session.close();
//			return list;
//		}
//		public int  BCommFormWriteGds (BCommFormGds gs) {
//			SqlSession session = sqlSessionFactory.openSession();
//			int cnt = session.insert("BCommFormWriteGds",gs);
//			session.commit();
//			session.close();
//			return cnt;
//		}
